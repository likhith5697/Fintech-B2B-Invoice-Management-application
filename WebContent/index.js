...
const fetchTableData = () => {
    $.get('/H2HBABBA2529/fetch', { page: pageno }, function(data, textStatus, jqXHR) {
        buildTable(data)
...
function addInvoice(){
	...
	$.post('/H2HBABBA2529/addInvoice', { custName: customerName, custId: customerNo, dueDa: dueDate, invNo: invoiceNo, invAmt: invoiceAmt, not: notes }, function() {
        alert("Data Added!");
     });
...
function editInvoice()
{
	...
	$.post('/H2HBABBA2529/editInvoice', { uniqId: editId, inamt: newInvoiceAmt, nn: newNotes }, function() {
...
function deleteInvoice()
{
	...
	{
		$.post('/H2HBABBA2529/deleteInvoice', {idList: arr[i]}
    	);
	}
	var deleteModalBg = document.querySelector('.delete-modal-bg');
	deleteModalBg.classList.remove('delete-modal-active');
